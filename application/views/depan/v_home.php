...
<head>
    ...
    <title>MTs Baiturrahim Jayapura</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/slider-4.jpg'?>" alt="First slide">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="<?php echo site_url('artikel');?>" class="btn btn-default btn-courses">Lihat Selengkapnya</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <a href="" target="_blank">MTs Baiturrahim Jayapura</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Jalan Ahmad Yani No. 70 Jayapura, Fax. 521913</p>
                        <p>Email : mtsbaiturrahim@gmail.com
                            <br> Phone : (0967) 534448</p>
